...
bool INITDESK(uint8 Mode)
{
    ...
    SETWORLDCOLORS();
    WRITE(576,156,45,WRITE_Center, MyRPort_PTR[0],3, _PT_Jahr);
    WRITE(576,207,45,WRITE_Center, MyRPort_PTR[0],3, PText[146]);
    WRITE(576,258,45,WRITE_Center, MyRPort_PTR[0],3, PText[147]);
