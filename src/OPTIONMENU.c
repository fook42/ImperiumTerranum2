    ...
    *_s1++ = ' ';
    ...
    for (i = 0; i < Player; ++i)
    {
        ...
        *(_s1+1) = 0;
        ...
        {
            Delay(RDELAY);
            if (LMB_PRESSED && (WinMouseX(1)>=100) && (WinMouseX(1)<=540))
            {
                offset = 100;
                for (j = 0; j < btx; ++j)
                {
                    if ((WinMouseY(1)>=offset) && (WinMouseY(1)<=(offset+30)) && (0 == Save.CivPlayer[j]))
                    {
                        b = true;
    ...
    {
        Delay(RDELAY);
        if (LMB_PRESSED && (WinMouseY(1)>=(200)) && (WinMouseY(1)<=(240))) 
        {
            offset = 123;
            for (i = 0; i < 5; ++i)
            {
                if ((WinMouseX(1)>offset) && (WinMouseX(1)<(offset+40)))
                {
                    HomePlanets = i;
                    break;
                }
...
void OPTIONMENU(int Mode)
{
    ...
    do
    {
        ...
        {
            PLAYSOUND(0,300);
            if ((WinMouseX(1)>=440) && (WinMouseX(1)<=574) && (WinMouseY(1)>=431) && (WinMouseY(1)<=454))
            {
                if      (WinMouseX(1) < 507) { Audio_enable = true; }
                else if (WinMouseX(1) > 507) { Audio_enable = false; }
                CHECKGADS(8);
            } else if ((1 == Mode) && (WinMouseX(1)>=550) && (WinMouseX(1)<=580)
                                   && (WinMouseY(1)>=120) && (WinMouseY(1)<=330))
            {
                if      ((WinMouseY(1) < 141) && (Player<5)) { ++Player; }
                else if ((WinMouseY(1) > 309) && (Player>1)) { --Player; }
                CHECKGADS(7);
            } else if ((1 == Mode) && (WinMouseX(1)>=455) && (WinMouseX(1)<=485)
                                   && (WinMouseY(1)>=120) && (WinMouseY(1)<=330))
            {
                if      ((WinMouseY(1) < 141) && (Level<10)) { ++Level; }
                else if ((WinMouseY(1) > 309) && (Level> 1)) { --Level; }
                CHECKGADS(6);
            } else {
                if ((WinMouseY(1)>=80) && (WinMouseY(1)<=144))
                {
                    if      ((WinMouseX(1)>= 60) && (WinMouseX(1)<=124)) { Save.PlayMySelf = true; }
                    else if ((WinMouseX(1)>=150) && (WinMouseX(1)<=214)) { Save.PlayMySelf = false; }
                    CHECKGADS(1);
                }
                
                if ((WinMouseY(1)>=160) && (WinMouseY(1)<=224))
                {
                    if      ((WinMouseX(1)>= 60) && (WinMouseX(1)<=124)) { Save.SmallFight = true; }
                    else if ((WinMouseX(1)>=150) && (WinMouseX(1)<=214)) { Save.SmallFight = false; }
                    CHECKGADS(2);
                }
                
                if ((WinMouseY(1)>=240) && (WinMouseY(1)<=304))
                {
                    if      ((WinMouseX(1)>= 60) && (WinMouseX(1)<=124)) { Save.SmallLand = true; }
                    else if ((WinMouseX(1)>=150) && (WinMouseX(1)<=214)) { Save.SmallLand = false; }
                    CHECKGADS(3);
                }
                
                if ((WinMouseY(1)>=320) && (WinMouseY(1)<=384))
                {
                    if      ((WinMouseX(1)>= 60) && (WinMouseX(1)<=124)) { Save.NoWorm = true; }
                    else if ((WinMouseX(1)>=150) && (WinMouseX(1)<=214)) { Save.NoWorm = false; }
                    CHECKGADS(4);
                }
                
                if ((WinMouseY(1)>=400) && (WinMouseY(1)<=464))
                {
                    if      ((WinMouseX(1)>= 60) && (WinMouseX(1)<=124)) { Save.FastMove = true; }
                    else if ((WinMouseX(1)>=150) && (WinMouseX(1)<=214)) { Save.FastMove = false; }
                    CHECKGADS(5);
                }
            }
            while(LMB_PRESSED) {};
