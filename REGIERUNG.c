...
void REGIERUNG()
{
    ...
    WRITEWIN( 61,  5,0,WRITE_Center,RPort_PTR,4,PText[746]);
    WRITEWIN( 61, 27,0,WRITE_Center,RPort_PTR,4,PText[747]);
    WRITEWIN( 61, 49,0,WRITE_Center,RPort_PTR,4,PText[748]);
    WRITEWIN( 61, 71,0,WRITE_Center,RPort_PTR,4,PText[749]);
    WRITEWIN( 61, 93,0,WRITE_Center,RPort_PTR,4,PText[750]);
    WRITEWIN( 61,115,0,WRITE_Center,RPort_PTR,4,PText[751]);
    WRITEWIN( 61,137,8,WRITE_Center,RPort_PTR,4,PText[752]);
